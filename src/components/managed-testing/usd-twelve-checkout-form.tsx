    ...
    >
      ...
      {!paddleReady ? (
        <p className="text-xs leading-5 text-muted">
          Paddle sandbox checkout is not configured on this server yet. You can still pay with a wallet and upload
          proof. TestLoop activates access only after a verified payment.
        </p>
      ) : (
        <p className="text-xs leading-5 text-muted">One-time payment. Sandbox cards only until Live is enabled.</p>
      )}
