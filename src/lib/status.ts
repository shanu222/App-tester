...
const ALLOWED: Record<TesterStatus, TesterStatus[]> = {
  DISCOVERED: ["CONTACTED", "REPLIED", "DECLINED", "BLOCKED", "ERROR"],
  CONTACTED: ["REPLIED", "EMAIL_RECEIVED", "DECLINED", "BLOCKED", "ERROR"],
  REPLIED: ["EMAIL_RECEIVED", "DECLINED", "BLOCKED", "ERROR"],
  ...
  ADDED: ["INVITATION_SENT", "GROUP_MEMBER", "OPT_IN_PENDING", "ERROR"],
  INVITATION_SENT: ["GROUP_MEMBER", "OPT_IN_PENDING", "ERROR"],
