...
export function UsdTwelvePackageCard({ amount }: { amount: number }) {
  return (
    <article className="flex flex-col rounded-card border border-brand bg-white p-5 shadow-card ring-1 ring-brand/20">
      <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-brand">TestLoop</p>
      <h3 className="mt-1 text-lg font-semibold text-slate-900">TestLoop</h3>
      <p className="mt-1 text-2xl font-semibold tabular-nums text-slate-900">{formatUsd(amount)} USD</p>
