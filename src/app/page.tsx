...
export default async function LandingPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-16">
      <p className="text-sm uppercase tracking-[0.2em] text-teal-300">TesterBridge</p>
      ...
      <section className="mt-12 rounded-2xl border border-slate-800 p-6">
        ...
        <ol className="mt-4 grid gap-3 text-sm text-slate-300 md:grid-cols-2">
          ...
          <li>6. TesterBridge processes Play / Google Group access when configured, or shows a manual fallback.</li>
