...
6. Grant tester access: an open track completes automatically and returns Google's opt-in URL; internal/closed returns the Play Console steps and stays **Awaiting Play Console** until confirmed.
