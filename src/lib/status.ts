...
const ALLOWED: Record<TesterStatus, TesterStatus[]> = {
  ...
  EMAIL_CONFIRMED: ["ADDING", "ADDED", "GROUP_MEMBER", "OPT_IN_PENDING", "DECLINED", "BLOCKED", "ERROR"],
  ADDING: ["ADDED", "GROUP_MEMBER", "ERROR", "DECLINED"],
...
export const TESTER_STATUS_LABELS: Record<TesterStatus, string> = {
  DISCOVERED: "TestLoop registered",
  CONTACTED: "Contacted",
  REPLIED: "Replied",
  EMAIL_RECEIVED: "TestLoop registered",
  EMAIL_CONFIRMED: "TestLoop registered",
  ADDING: "Waiting for developer",
  ADDED: "Developer confirmed",
  INVITATION_SENT: "Invitation sent",
  GROUP_MEMBER: "Joining Google Group",
  OPT_IN_PENDING: "TestLoop registered",
  OPTED_IN: "Opt-in recorded in TestLoop",
  INSTALL_STATUS_UNKNOWN: "Install status unknown",
  TESTING: "Testing activity (TestLoop)",
