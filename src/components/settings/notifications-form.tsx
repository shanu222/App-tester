      ...
      <div className="mt-6 space-y-4">
        ...
        <div>
          ...
          <div className="mt-2">
            ...
            <Checkbox
              className="py-2"
              checked={prefs.testingMarketplace}
              onChange={(event) => setPrefs((current) => ({ ...current, testingMarketplace: event.target.checked }))}
              label="Public testing invitations"
            />
          </div>
        </div>
      </div>
