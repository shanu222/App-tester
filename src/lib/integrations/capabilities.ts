...
export const FACEBOOK_GROUP_LIMITATION =
  "Automatic Facebook Group discovery, commenting, and inbox monitoring are unavailable. Meta deprecated the Groups API in Graph API v19 and removed it for all versions in April 2024. TesterBridge will not scrape groups. Import a post manually, generate a reply, then paste the comment into Facebook yourself.";
...
export const PLAY_INSTALL_LIMITATION =
  "Google Play APIs do not confirm that a specific Gmail downloaded the app. Per-tester install status stays unknown unless the tester's app sends TesterBridge telemetry.";
